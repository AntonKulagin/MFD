  ...
  return (
    <div>
      ...
      <form className='form' onSubmit={handleSubmit}>
        <Input value={fieldsData.name} type='text' name='name' placeholder='Имя' onChange={handleChange} />
        <Input value={fieldsData.nick} type='text' name='nick' placeholder='Ник' onChange={handleChange} />
        <Input
